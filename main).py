...
with open(r'C:\Users\SIDHARTHA\Desktop\miniProj\False-news-Detection\model1.pkl', 'rb') as model_file:
    model = pickle.load(model_file)

with open(r'C:\Users\SIDHARTHA\Desktop\miniProj\False-news-Detection\model2.pkl', 'rb') as model_lr_file:
    model_lr = pickle.load(model_lr_file)

with open(r'C:\Users\SIDHARTHA\Desktop\miniProj\False-news-Detection\tfidf_vectorizer.pkl', 'rb') as tfidf_file:
